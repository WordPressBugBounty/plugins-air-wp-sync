...
<div class="airwpsync-admin-header">
	...
	<a class="airwpsync-admin-header-link" href="<?php echo esc_url( admin_url( 'edit.php?post_type=airwpsync-connection' ) ); ?>">
		<img class="airwpsync-admin-header-logo" width="20" src="<?php echo esc_url( plugins_url( 'assets/images/logo-wpconnect-icon.svg', __DIR__ ) ); ?>"/>
		<span><?php esc_html_e( 'Air WP Sync', 'air-wp-sync' ); ?></span>
	</a>
	</h2>

<a class="air-wp-sync-admin-header-promo" href="https://wpconnect.co/air-wp-sync-plugin/#compare-plans" target="_blank">
	...
	<img width="105" height="26" src="<?php echo esc_url( plugins_url( 'assets/images/logo-wpconnect-v2.png', __DIR__ ) ); ?>"/>
</a>
</div>
