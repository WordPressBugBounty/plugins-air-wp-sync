 ...
 * Language pack class.
 * Main T15S library.
 * Handles translations on TranslationsPress
 *
 ...
 */
class Air_WP_Sync_Language_Packs {
	...
	/**
	 * Full TranslationsPress API URL for the project.
	 *
	 * @var string $api_url
	 */
	 ...
	 * @param string $api_url Full TranslationsPress API URL for the project.
	 */
